...
const Notificationpopover = ({ open, handleNotificationClose, anchorEl, notificationState }: any) => {
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', py: 2, px: 2.5 }}>
        <Box sx={{ flexGrow: 1 }}>
          ...
          <Typography variant='body2' sx={{ color: 'text.secondary' }}>
            You have {notificationState?.notificationArray.length} unread messages
          </Typography>
        </Box>
      </Box>
