...
const rows = [
  createData('Shakeeb', 'shakeeb.arsalan@quokkalabs.com', 'React.JS', 4000, 5, 'yes'),
  createData('Tanmay', 'tanmay.mazumdar@quokkalabs.com', 'React.JS', 4000, 4, 'no'),
  createData('Shubham', 'shubham.chaudhary@quokkalabs.com', 'React.JS', 3000, 2, 'yes'),
  createData('Vinayak', 'vinayak.@quokkalabs.com', 'Angular', 1000, 2, 'yes'),
  createData('Anshul', 'anhsul.dimri@quokkalabs.com', 'Node.JS', 3000, 3, 'yes'),
  createData('Risalat', 'rishalat.shamoa@quokkalabs.com', 'Java', 4000, 3, 'no'),
]
                ...
                return (
                  ...
                  >
                    {columns.map(column => {
                      ...
                      return (
                        <TableCell key={column.id} align='center' sx={{ padding: 1 }}>
                    ...
                    >
                      <Box
                        sx={{
                          visibility: showMoreOptions === index ? 'visible' : 'hidden',
                        }}
                      >
