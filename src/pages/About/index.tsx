    ...
    <>
      ...
      <div className="aboutUsSection">
        ...
        <div className="aboutInfo">
          ...
          <div className="firstContent">
            <h4>Why Join?</h4>
            <p>
              Primary goal of TALENT POOL is to help and decrease the hassle of
              companies with similar interest of hiring and outsourcing with
              clear monetary benefits.
            </p>
          </div>
          {/* </div>
          ...
          <div className="firstContent">
            ...
            <p>
              We are dedicated to helping working professionals fulfill their
              goals and expand their horizons beyond the limitations of every
      ...
      <div className="betterYet">
        <div className="headBetterYet">
          <h4 style={{ fontSize: "1.5rem", paddingBottom: "2rem" }}>
